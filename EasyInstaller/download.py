...
def main():
    versions = requests.get('https://raw.githubusercontent.com/heyitszinx-ongit/easyinstaller-manifests/main/Manifests.json').json()
    ...
    print("HeyItsZinx for maintaining EasyInstaller.")
